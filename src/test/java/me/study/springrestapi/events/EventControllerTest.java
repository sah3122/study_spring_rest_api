...
import me.study.springrestapi.accounts.AccountRepository;
...
//    EventRepository eventRepository;
        ...
        mockMvc.perform(post("/api/events/")
                ...
                .andDo(document("create-event",
                        links(
                                ...
                                linkWithRel("query-events").description("link to query envents"),
                                linkWithRel("update-event").description("link to update event"),
                                linkWithRel("profile").description("lprofileink to update event")
                        ),
                        requestHeaders(
    ...
    @Test
    @DisplayName("입력받을수 없는 값을 사용하는 경우에 에러가 발생하는 테스트")
    ...
    @Test
    @DisplayName("입력값이 비어있는 경우 발생하는 테스트")
    ...
    @Test
    @DisplayName("입력값이 잘못 된 경우 발생하는 테스트")
    ...
    @Test
    @DisplayName("없는 이벤트는 조회했을 때 404 응답")
    public void queryEvent404() throws Exception {
        this.mockMvc.perform(get("/api/events/13531"))
    ...
    @Test
    @DisplayName("입력 값이 비어있는 경우 수정 실패")
    ...
    public void updateEvent404() throws Exception {
        ...
        // when & then
        this.mockMvc.perform(put("/api/events/123421")
                .header(HttpHeaders.AUTHORIZATION, getBearerToken())
                .contentType(MediaType.APPLICATION_JSON)
                .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
